...
public static class DDDTemplateSolutionEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
             ...
             * USE DDDTemplateSolutionModuleExtensionConfigurator CLASS (in the Domain.Shared project)
